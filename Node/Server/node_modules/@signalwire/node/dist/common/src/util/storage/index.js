...
const _get = (storageType, key) => __awaiter(this, void 0, void 0, function* () {
    if (_inNode())
        return null;
    const res = window[storageType].getItem(helpers_1.mutateStorageKey(key));
    return helpers_1.safeParseJson(res);
});
const _set = (storageType, key, value) => __awaiter(this, void 0, void 0, function* () {
    if (_inNode())
        return null;
...
const _remove = (storageType, key) => __awaiter(this, void 0, void 0, function* () {
    if (_inNode())
        return null;
