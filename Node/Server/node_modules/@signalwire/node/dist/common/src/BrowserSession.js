...
class BrowserSession extends BaseSession_1.default {
    ...
    disconnect() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            Object.keys(this.calls).forEach(k => this.calls[k].setState(call_1.State.Purge));
            this.calls = {};
    ...
    getVideoDevices() {
        return helpers_1.getDevices(constants_1.DeviceType.Video).catch(error => {
            Handler_1.trigger(constants_1.SwEvent.MediaError, error, this.uuid);
            return [];
        });
    }
    getAudioInDevices() {
        return helpers_1.getDevices(constants_1.DeviceType.AudioIn).catch(error => {
            Handler_1.trigger(constants_1.SwEvent.MediaError, error, this.uuid);
            return [];
        });
    }
    getAudioOutDevices() {
        return helpers_1.getDevices(constants_1.DeviceType.AudioOut).catch(error => {
            Handler_1.trigger(constants_1.SwEvent.MediaError, error, this.uuid);
            return [];
        });
    }
