...
class Peer {
    ...
    _createAnswer() {
        ...
        const sessionDescr = webrtc_1.sdpToJsonHack({ sdp, type: constants_1.PeerType.Offer });
    ...
    _isOffer() {
        return this.type === constants_1.PeerType.Offer;
    }
    _isAnswer() {
        return this.type === constants_1.PeerType.Answer;
    }
    _config() {
