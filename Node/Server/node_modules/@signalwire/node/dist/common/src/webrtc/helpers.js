...
const getUserMedia = (constraints) => __awaiter(this, void 0, void 0, function* () {
...
const getDevices = (kind = null) => __awaiter(this, void 0, void 0, function* () {
...
const scanResolutions = (deviceId) => __awaiter(this, void 0, void 0, function* () {
    const supported = [];
...
const getMediaConstraints = (options) => __awaiter(this, void 0, void 0, function* () {
...
const assureDeviceId = (id, label, kind) => __awaiter(this, void 0, void 0, function* () {
    const devices = yield WebRTC.enumerateDevices()
        .catch(error => [])
...
const checkDeviceIdConstraints = (id, label, kind, constraints) => __awaiter(this, void 0, void 0, function* () {
