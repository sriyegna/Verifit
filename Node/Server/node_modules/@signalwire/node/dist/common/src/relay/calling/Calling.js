...
class Calling extends Relay_1.default {
    ...
    newCall(params) {
        const { type, from: from_number, to: to_number, timeout = relay_1.DEFAULT_CALL_TIMEOUT } = params;
        if (!type || !from_number || !to_number || !timeout) {
            throw new TypeError(`Invalid parameters to create a new Call.`);
        }
        const device = { type, params: { from_number, to_number, timeout } };
        return new Call_1.default(this, { device });
    }
    dial(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const device = { type, params: { from_number, to_number, timeout } };
            const call = new Call_1.default(this, { device });
    ...
    _onState(params) {
        ...
        if (call) {
            ...
            const peerCall = new Call_1.default(this, params);
        }
        else {
